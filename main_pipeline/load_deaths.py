...
# Define function to load deaths data
def main(dest):
    logger.info('Loading transformed deaths data')
    df = read_csv_temp(os.path.join(os.path.join(os.path.dirname(__file__)), 'temp', 'cleaned_deaths.csv'))
    logger.info('Loading deaths data to data warehouse')
