...
# Define function to load cases
def main(dest):
    logger.info('Loading transformed cases data')
    df = read_csv_temp(os.path.join(os.path.join(os.path.dirname(__file__)), 'temp', 'cleaned_cases.csv'))
    logger.info('Loading cases to data warehouse')
